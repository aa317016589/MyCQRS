...
namespace Dapper.Contrib.Linq2Dapper.Helpers
{
    internal class Helper
    {
        ...
        //internal static bool IsHasValue(Expression expr)
        //{
        //    return (expr is MemberExpression) && (((MemberExpression)expr).Expression.NodeType == ExpressionType.Parameter);
        //}
        ...
        internal static bool IsVariable2(Expression expr)
        {
            return (expr is MemberExpression) && (((MemberExpression)expr).Expression.NodeType == ExpressionType.MemberAccess);
        }
