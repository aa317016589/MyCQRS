...
namespace Dapper.Contrib.Linq.Extensions
{
    public static class LinqExtensions
    {
        ...
        public static IEnumerable<dynamic> Cast(this System.Collections.IEnumerable sourceobjects, Type elementType)
        {
            ...
            var lambdaCast = Expression.Lambda(castExpression,
                Expression.Parameter(typeof (System.Collections.IEnumerable)));
        ...
        public static IEnumerable<TSource> Distinct<TSource>(this IEnumerable<TSource> first,
            IComparer<TSource> comparer)
        {
            SortedSet<TSource> second = new SortedSet<TSource>(comparer: comparer);
            //can also use SortedList<Tkey,Tvalue>
